...
com.init = function (stype) {
    //棋局初始化
    com.nowStype = stype || com.getCookie("stype") || "stype1";//获取风格
    ...
    com.childList = com.childList || [];//步列表
...
function load() {
    ...
    com.dot = new com.class.Dot();//棋子走的点
    com.pane = new com.class.Pane();//棋子外框
...
var AA = ['C0', 'M0', 'X0', 'X1', 'M1', 'C1', 'P0', 'P1', 'Z0', 'Z1', 'Z2', 'Z3', 'Z4', 'c0', 'm0', 'x0',  'x1', 'm1', 'c1', 'p0', 'p1', 'z0', 'z1', 'z2', 'z3', 'z4'];
var BB=['S0', 'J0', 'S1', 's0', 'j0', 's1'];
function newmap() {
    AA = ['C0', 'M0', 'X0', 'X1', 'M1', 'C1', 'P0', 'P1', 'Z0', 'Z1', 'Z2', 'Z3', 'Z4', 'c0', 'm0', 'x0', 'x1', 'm1', 'c1', 'p0', 'p1', 'z0', 'z1', 'z2', 'z3', 'z4'];
    BB=['S0', 'J0', 'S1', 's0', 'j0', 's1'];
    var ss = [
        [getAA(), getAA(), getAA(),'S0','J0','S1', getAA(), getAA(), getAA()],
        [, , , , , , , ,],
        [, getAA(), , , , , , getAA(),],
        [getAA(), , getAA(), , getAA(), , getAA(), , getAA()],
        [, , , , , , , ,],
        [, , , , , , , ,],
        [getAA(), , getAA(), , getAA(), , getAA(), , getAA()],
        [, getAA(), , , , , , getAA(),],
...
function getAA() {
    const randomIndex = Math.floor( Math.random()* AA.length);
    return AA.splice(randomIndex, 1)[0];
}
    ...
    this.show = function () {
        if (this.isShow) {
            ...
            if(!this.IsFan){
                ...
                var imga = new Image();
				imga.src = "img/" + com.page + "/" + "back" + ".png";
                com.ct.drawImage(imga, com.spaceX * this.x + com.pointStartX, com.spaceY * this.y + com.pointStartY);
            }
            com.ct.restore();
        }
    }
